    ...
    class Program
    {
        ...
        */
        ...
        public static IList<IList<int>> FindMissingRanges(int[] nums, int lower, int upper)
        {
            try
            {
                ...
                if (lower < nums[0]) //Find the missing range if the lower limit is less than the first element of nums.
                {
                ...
                for (int i = 1; i < nums.Length; i++)
                {
                    ...
                    { // checking if numbers are non-consecutive
                        missingrange = new List<int>(); //ready to accept the new ranges by resetting the missing range list.
        ...
        */
        ...
        public static bool IsValid(string s)
        {
            try
            {
                ...
                {
                    char c = s[i]; //Take the string at this place and save it to 'c'.
                    ...
                    else if (goodbracketcombos.ContainsValue(c)) // Validate the character's dictionary value in 'c'
                    {
        ...
        */
        ...
        public static int MaxProfit(int[] prices)
        {
            try
            {
                ...
                {
                    if (prices[i] < lowprice) //this loop, which assigns a low price to the stock with the lowest price
                    {
                        lowprice = prices[i];
                    }
                    else
        ...
        */
        ...
        public static bool IsStrobogrammatic(string s)
        {
            try
            {
                ...
                while (leftpointer <= rightpointer) // will move through the points toward the int's center and halt there
                {
        ...
        public static int NumIdenticalPairs(int[] nums)
        {
            try
            {
                ...
                foreach (int num in nums)
                {
                    ...
                    {
                        // In case the number has been viewed previously, add that number to the total number of good pairs.
        ...
        */
        ...
        public static int ThirdMax(int[] nums)
        {
            try
            {
                long firstMax = long.MinValue; // Set the initial value as low as feasible.
        ...
        public static IList<string> GeneratePossibleNextMoves(string currentState)
        {
            try
            {
                ...
                for (int i = 0; i < currentState.Length - 1; i++) // need the '- 1' because we are checking 'i + 1' in the loop and it will keep us in bounds
                {
                    ...
                    {
                        char[] nextState = currentState.ToCharArray(); // converting this to an array to facilitate manipulation
